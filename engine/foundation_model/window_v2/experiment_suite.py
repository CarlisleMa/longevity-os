"""Run and summarize target-token window JEPA suites."""
...
DEFAULT_OUTPUT_ROOT = "foundation_jepa/window_v2/artifacts/horizon_suite"
...
def add_shared_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=["random"],
        help="Comma/space separated event samplers.",
    )
...
def run_record(record: dict[str, Any]) -> None:
    ...
    command = [sys.executable, "-u", "-m", "foundation_jepa.window_v2.train"]
...
def summary_row(path: Path, manifest_lookup: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    keys = [
        ...
        "pred_std_cgm",
        "pred_std_wearable",
        "pred_std_environment",
        "target_std_cgm",
        "target_std_wearable",
        "target_std_environment",
    ]
...
def parse_args() -> argparse.Namespace:
    ...
    manifest_parser.add_argument(
        "--manifest",
        default="foundation_jepa/window_v2/artifacts/horizon_suite/manifest.jsonl",
    )
    ...
    summarize_parser.add_argument(
        "--output-csv",
        default="foundation_jepa/window_v2/artifacts/horizon_suite/summary.csv",
    )
